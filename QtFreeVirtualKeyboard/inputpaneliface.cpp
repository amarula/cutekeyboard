...
InputPanelIface::InputPanelIface(QObject *parent)
    : QObject(parent)
    , pimpl(new InputPanelIfacePrivate)
{}
...
QColor InputPanelIface::btnTextColor() const
{
    return pimpl->btnTextColor;
}
...
QString InputPanelIface::backspaceIcon() const
{
    return pimpl->backspaceIcon;
}
...
QString InputPanelIface::shiftOnIcon() const
{
    return pimpl->shiftOnIcon;
}
...
QString InputPanelIface::shiftOffIcon() const
{
    return pimpl->shiftOffIcon;
}
